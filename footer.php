...
<?
$APPLICATION->AddHeadScript(SITE TEMPLATE PATH.'/js/jquery.min.js');
$APPLICATION->AddHeadScript(SITE TEMPLATE PATH.'/js/owl.carousel.min.js');
$APPLICATION->AddHeadScript(SITE TEMPLATE PATH.'/');
?>
